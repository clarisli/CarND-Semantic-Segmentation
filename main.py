...
def load_vgg(sess, vgg_path):
    ...
    return x, keep, layer3_out, layer4_out, layer7_out
...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    layer4_conv_1x1 = tf.layers.conv2d(pool4_out_scaled, num_classes, 1, padding='same', 
                                kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
    ...
    layer3_conv_1x1 = tf.layers.conv2d(pool3_out_scaled, num_classes, 1, padding='same', 
                                kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
